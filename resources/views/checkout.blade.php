        ...
        <div class="col-md-5 offset-md-1">
            ...
            <div class="row">
                ...
                <div class="col-md-4 offset-md-4">
                    <span class="light-text" style="display: inline-block">BDT {{ format($subtotal) }}</span>
                </div>
            </div>
            @if (session()->has('coupon'))
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <span class="light-text" style="display: inline">- BDT {{ format($discount) }}</span>
                    </div>
                </div><hr>
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 offset-md-4">
                        <span class="light-text" style="display: inline-block">BDT {{ format($newSubtotal) }}</span>
                    </div>
                </div>
            @endif
            <div class="row">
                ...
                <div class="col-md-4 offset-md-4">
                    <span class="light-text" style="display: inline-block">BDT {{ format($tax) }}</span>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4 offset-md-4">
                    <span class="text-right" style="display: inline-block">BDT {{ format($total) }}</span>
                </div>
            </div>
            <hr>
            @if (!session()->has('coupon'))
